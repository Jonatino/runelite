...
public class SecureRandomCallable implements Callable {
	...
	static void changeWorld(World var0) {
		...
		SocketInfo.worldPort = Client.gameBuild == 0 ? 43594 : var0.id + 40000; // L: 1511
		Players.js5Port = Client.gameBuild == 0 ? 443 : var0.id + 50000; // L: 1512
		ArchiveDiskAction.currentPort = SocketInfo.worldPort; // L: 1513
	} // L: 1514
